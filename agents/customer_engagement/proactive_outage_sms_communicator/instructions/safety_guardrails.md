# Safety Guardrails: Proactive Outage Sms Communicator
...
- If telemetry or data for Proactive Outage Sms Communicator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
