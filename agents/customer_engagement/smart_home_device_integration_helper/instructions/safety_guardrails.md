# Safety Guardrails: Smart Home Device Integration Helper
...
- If telemetry or data for Smart Home Device Integration Helper is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
