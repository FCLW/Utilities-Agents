# Safety Guardrails: Move In Move Out Coordinator
...
- If telemetry or data for Move In Move Out Coordinator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
