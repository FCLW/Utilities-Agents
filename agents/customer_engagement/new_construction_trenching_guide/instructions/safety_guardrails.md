# Safety Guardrails: New Construction Trenching Guide
...
- If telemetry or data for New Construction Trenching Guide is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
