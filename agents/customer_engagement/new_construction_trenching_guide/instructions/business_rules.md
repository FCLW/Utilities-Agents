# Business Rules: New Construction Trenching Guide

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to New Construction Trenching Guide.
