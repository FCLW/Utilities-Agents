# Business Rules: Solar Panel Installation Advisor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Solar Panel Installation Advisor.
