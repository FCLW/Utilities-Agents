# Safety Guardrails: Solar Panel Installation Advisor
...
- If telemetry or data for Solar Panel Installation Advisor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
