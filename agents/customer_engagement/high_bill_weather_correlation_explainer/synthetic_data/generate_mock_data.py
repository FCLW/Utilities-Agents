#!/usr/bin/env python3
"""
Synthetic data generator for high_bill_weather_correlation_explainer grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "high_bill_weather_correlation_explainer"
