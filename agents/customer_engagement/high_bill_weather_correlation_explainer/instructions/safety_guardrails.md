# Safety Guardrails: High Bill Weather Correlation Explainer
...
- If telemetry or data for High Bill Weather Correlation Explainer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
