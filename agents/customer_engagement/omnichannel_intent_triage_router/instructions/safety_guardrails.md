# Safety Guardrails: Omnichannel Intent Triage Router
...
- If telemetry or data for Omnichannel Intent Triage Router is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
