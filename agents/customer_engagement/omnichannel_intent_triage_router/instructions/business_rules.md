# Business Rules: Omnichannel Intent Triage Router

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Omnichannel Intent Triage Router.
