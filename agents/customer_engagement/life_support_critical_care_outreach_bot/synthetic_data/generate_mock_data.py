#!/usr/bin/env python3
"""
Synthetic data generator for life_support_critical_care_outreach_bot grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "life_support_critical_care_outreach_bot"
