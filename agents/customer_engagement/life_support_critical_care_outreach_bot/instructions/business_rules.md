# Business Rules: Life Support Critical Care Outreach Bot

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Life Support Critical Care Outreach Bot.
