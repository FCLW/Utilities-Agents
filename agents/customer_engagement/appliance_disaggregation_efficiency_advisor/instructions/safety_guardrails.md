# Safety Guardrails: Appliance Disaggregation Efficiency Advisor
...
- If telemetry or data for Appliance Disaggregation Efficiency Advisor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
