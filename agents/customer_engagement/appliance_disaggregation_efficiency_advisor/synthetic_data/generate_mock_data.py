#!/usr/bin/env python3
"""
Synthetic data generator for appliance_disaggregation_efficiency_advisor grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "appliance_disaggregation_efficiency_advisor"
