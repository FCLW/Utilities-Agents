# Safety Guardrails: Ev Rate Plan Comparison Guide
...
- If telemetry or data for Ev Rate Plan Comparison Guide is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
