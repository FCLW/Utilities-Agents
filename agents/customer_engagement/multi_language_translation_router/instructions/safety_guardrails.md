# Safety Guardrails: Multi Language Translation Router
...
- If telemetry or data for Multi Language Translation Router is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
