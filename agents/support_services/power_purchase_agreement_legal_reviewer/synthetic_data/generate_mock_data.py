#!/usr/bin/env python3
"""
Synthetic data generator for power_purchase_agreement_legal_reviewer grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "power_purchase_agreement_legal_reviewer"
