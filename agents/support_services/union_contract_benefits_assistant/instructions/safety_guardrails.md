# Safety Guardrails: Union Contract Benefits Assistant
...
- If telemetry or data for Union Contract Benefits Assistant is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
