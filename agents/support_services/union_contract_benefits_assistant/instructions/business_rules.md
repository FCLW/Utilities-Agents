# Business Rules: Union Contract Benefits Assistant

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Union Contract Benefits Assistant.
