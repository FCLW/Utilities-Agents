# Safety Guardrails: Warehouse Inventory Drone Auditor
...
- If telemetry or data for Warehouse Inventory Drone Auditor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
