...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE utility_vehicle_fleet_maintenance_tracker_data;",
        "DELETE FROM utility_vehicle_fleet_maintenance_tracker_data WHERE name=1;",
        "TRUNCATE TABLE utility_vehicle_fleet_maintenance_tracker_data;",
        "ALTER TABLE utility_vehicle_fleet_maintenance_tracker_data DROP COLUMN x;",
        "INSERT INTO utility_vehicle_fleet_maintenance_tracker_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM utility_vehicle_fleet_maintenance_tracker_data LIMIT 10")
