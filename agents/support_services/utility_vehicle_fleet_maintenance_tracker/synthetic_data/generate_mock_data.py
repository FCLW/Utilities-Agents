#!/usr/bin/env python3
"""
Synthetic data generator for utility_vehicle_fleet_maintenance_tracker grounded in golden-dataset.json.
...
def generate_data():
    ...
    domain_name = "support_services"
    agent_name = "utility_vehicle_fleet_maintenance_tracker"
    ...
    schema = {"cols": ['timestamp_column', 'record_id', 'metric_value', 'status_flag', 'anomaly_score', 'entity_name', 'metric_name', 'current_value', 'baseline_target', 'delta_pct', 'substation_or_region', 'details_json']}
