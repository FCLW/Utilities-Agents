# Safety Guardrails: Utility Vehicle Fleet Maintenance Tracker
...
- If telemetry or data for Utility Vehicle Fleet Maintenance Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
