...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE loto_arc_flash_safety_knowledge_bot_data;",
        "DELETE FROM loto_arc_flash_safety_knowledge_bot_data WHERE name=1;",
        "TRUNCATE TABLE loto_arc_flash_safety_knowledge_bot_data;",
        "ALTER TABLE loto_arc_flash_safety_knowledge_bot_data DROP COLUMN x;",
        "INSERT INTO loto_arc_flash_safety_knowledge_bot_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM loto_arc_flash_safety_knowledge_bot_data LIMIT 10")
