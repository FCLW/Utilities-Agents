# Safety Guardrails: Mutual Assistance Per Diem Auditor
...
- If telemetry or data for Mutual Assistance Per Diem Auditor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
