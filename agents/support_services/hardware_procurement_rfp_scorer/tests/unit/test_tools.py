...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE hardware_procurement_rfp_scorer_data;",
        "DELETE FROM hardware_procurement_rfp_scorer_data WHERE name=1;",
        "TRUNCATE TABLE hardware_procurement_rfp_scorer_data;",
        "ALTER TABLE hardware_procurement_rfp_scorer_data DROP COLUMN x;",
        "INSERT INTO hardware_procurement_rfp_scorer_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM hardware_procurement_rfp_scorer_data LIMIT 10")
