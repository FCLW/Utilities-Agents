# Safety Guardrails: Hardware Procurement Rfp Scorer
...
- If telemetry or data for Hardware Procurement Rfp Scorer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
