# Safety Guardrails: Employee Fatigue Risk Monitor
...
- If telemetry or data for Employee Fatigue Risk Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
