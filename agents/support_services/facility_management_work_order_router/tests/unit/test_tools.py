...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE facility_management_work_order_router_data;",
        "DELETE FROM facility_management_work_order_router_data WHERE name=1;",
        "TRUNCATE TABLE facility_management_work_order_router_data;",
        "ALTER TABLE facility_management_work_order_router_data DROP COLUMN x;",
        "INSERT INTO facility_management_work_order_router_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM facility_management_work_order_router_data LIMIT 10")
