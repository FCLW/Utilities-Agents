# Business Rules: Facility Management Work Order Router

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Facility Management Work Order Router.
