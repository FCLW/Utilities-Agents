# Safety Guardrails: Facility Management Work Order Router
...
- **Tier 2 Definition for this Agent**: Dispatching physical field crews, rolling trucks, or redirecting mutual assistance resources.
...
- If telemetry or data for Facility Management Work Order Router is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
