# Safety Guardrails: Localized Outage Ping Diagnostic Bot
...
- If telemetry or data for Localized Outage Ping Diagnostic Bot is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
