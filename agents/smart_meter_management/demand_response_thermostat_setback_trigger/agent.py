...
telemetry_callbacks = get_telemetry_callbacks(agent_name="demand_response_thermostat_setback_trigger")
...
agent = Agent(
    name="demand_response_thermostat_setback_trigger",
    model="gemini-3.7-flash",
    description="Dispatches automated temperature setback signals to enrolled smart thermostats during grid emergency peak load reduction events.",
