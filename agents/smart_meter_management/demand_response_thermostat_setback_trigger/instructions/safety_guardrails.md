# Safety Guardrails: Demand Response Thermostat Setback Trigger
...
- If telemetry or data for Demand Response Thermostat Setback Trigger is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
