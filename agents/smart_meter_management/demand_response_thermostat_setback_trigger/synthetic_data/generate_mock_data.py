#!/usr/bin/env python3
"""
Synthetic data generator for demand_response_thermostat_setback_trigger grounded in golden-dataset.json.
...
def generate_data():
    ...
    domain_name = "smart_meter_management"
    agent_name = "demand_response_thermostat_setback_trigger"
    ...
    schema = {"cols": ['timestamp_column', 'meter_id', 'consumption_kwh', 'status_flag', 'anomaly_score', 'entity_name', 'metric_name', 'current_value', 'baseline_target', 'delta_pct', 'substation_or_region', 'details_json']}
