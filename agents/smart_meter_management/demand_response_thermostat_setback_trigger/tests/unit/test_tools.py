...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE demand_response_thermostat_setback_trigger_data;",
        "DELETE FROM demand_response_thermostat_setback_trigger_data WHERE name=1;",
        "TRUNCATE TABLE demand_response_thermostat_setback_trigger_data;",
        "ALTER TABLE demand_response_thermostat_setback_trigger_data DROP COLUMN x;",
        "INSERT INTO demand_response_thermostat_setback_trigger_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM demand_response_thermostat_setback_trigger_data LIMIT 10")
