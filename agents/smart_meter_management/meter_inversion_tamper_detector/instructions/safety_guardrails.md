# Safety Guardrails: Meter Inversion Tamper Detector
...
- If telemetry or data for Meter Inversion Tamper Detector is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
