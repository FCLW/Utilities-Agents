# Business Rules: Meter Inversion Tamper Detector

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Meter Inversion Tamper Detector.
