...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE meter_inversion_tamper_detector_data;",
        "DELETE FROM meter_inversion_tamper_detector_data WHERE name=1;",
        "TRUNCATE TABLE meter_inversion_tamper_detector_data;",
        "ALTER TABLE meter_inversion_tamper_detector_data DROP COLUMN x;",
        "INSERT INTO meter_inversion_tamper_detector_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM meter_inversion_tamper_detector_data LIMIT 10")
