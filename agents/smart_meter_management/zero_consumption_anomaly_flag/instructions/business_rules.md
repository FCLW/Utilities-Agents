# Business Rules: Zero Consumption Anomaly Flag

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Zero Consumption Anomaly Flag.
