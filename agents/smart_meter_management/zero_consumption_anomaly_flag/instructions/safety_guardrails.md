# Safety Guardrails: Zero Consumption Anomaly Flag
...
- If telemetry or data for Zero Consumption Anomaly Flag is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
