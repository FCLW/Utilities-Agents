# Safety Guardrails: Prepaid Metering Balance Tracker
...
- If telemetry or data for Prepaid Metering Balance Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
