# Safety Guardrails: Meter Firmware Ota Scheduler
...
- **Tier 2 Definition for this Agent**: Over-The-Air (OTA) firmware updates to hardware fleets (e.g. Smart Meters).
...
- If telemetry or data for Meter Firmware Ota Scheduler is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
