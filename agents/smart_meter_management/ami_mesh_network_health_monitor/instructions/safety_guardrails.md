# Safety Guardrails: Ami Mesh Network Health Monitor
...
- If telemetry or data for Ami Mesh Network Health Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
