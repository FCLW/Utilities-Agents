...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE ami_mesh_network_health_monitor_data;",
        "DELETE FROM ami_mesh_network_health_monitor_data WHERE name=1;",
        "TRUNCATE TABLE ami_mesh_network_health_monitor_data;",
        "ALTER TABLE ami_mesh_network_health_monitor_data DROP COLUMN x;",
        "INSERT INTO ami_mesh_network_health_monitor_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM ami_mesh_network_health_monitor_data LIMIT 10")
