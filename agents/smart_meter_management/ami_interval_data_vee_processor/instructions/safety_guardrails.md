# Safety Guardrails: Ami Interval Data Vee Processor
...
- If telemetry or data for Ami Interval Data Vee Processor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
