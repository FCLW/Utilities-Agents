# Business Rules: Ami Interval Data Vee Processor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Ami Interval Data Vee Processor.
