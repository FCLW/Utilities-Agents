...
telemetry_callbacks = get_telemetry_callbacks(agent_name="smart_meter_temperature_anomaly_detector")
...
agent = Agent(
    name="smart_meter_temperature_anomaly_detector",
    model="gemini-3.7-flash",
    description="Monitors internal meter collar terminal temperature telemetry to identify high-resistance electrical connections and prevent meter fires.",
