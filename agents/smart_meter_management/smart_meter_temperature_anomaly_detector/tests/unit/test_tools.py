...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE smart_meter_temperature_anomaly_detector_data;",
        "DELETE FROM smart_meter_temperature_anomaly_detector_data WHERE name=1;",
        "TRUNCATE TABLE smart_meter_temperature_anomaly_detector_data;",
        "ALTER TABLE smart_meter_temperature_anomaly_detector_data DROP COLUMN x;",
        "INSERT INTO smart_meter_temperature_anomaly_detector_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM smart_meter_temperature_anomaly_detector_data LIMIT 10")
