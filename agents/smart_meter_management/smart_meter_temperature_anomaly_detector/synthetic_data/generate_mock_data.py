#!/usr/bin/env python3
"""
Synthetic data generator for smart_meter_temperature_anomaly_detector grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "smart_meter_temperature_anomaly_detector"
