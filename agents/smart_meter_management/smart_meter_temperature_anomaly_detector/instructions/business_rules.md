# Business Rules: Smart Meter Temperature Anomaly Detector

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Smart Meter Temperature Anomaly Detector.
