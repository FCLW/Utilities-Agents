# Safety Guardrails: Smart Meter Temperature Anomaly Detector
...
- If telemetry or data for Smart Meter Temperature Anomaly Detector is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
