# Safety Guardrails: Customer Baseline Load Cbl Calculator
...
- **Dataset Restriction**: Only query datasets authorized for the Smart Meter Management domain.
...
- If telemetry or data for Customer Baseline Load Cbl Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
