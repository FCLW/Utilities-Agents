# Business Rules: Substation Battery Health Tracker

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Substation Battery Health Tracker.
