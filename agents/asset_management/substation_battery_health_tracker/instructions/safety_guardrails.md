# Safety Guardrails: Substation Battery Health Tracker
...
- If telemetry or data for Substation Battery Health Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
