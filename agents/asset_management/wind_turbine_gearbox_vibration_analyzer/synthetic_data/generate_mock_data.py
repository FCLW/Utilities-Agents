#!/usr/bin/env python3
"""
Synthetic data generator for wind_turbine_gearbox_vibration_analyzer grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "wind_turbine_gearbox_vibration_analyzer"
