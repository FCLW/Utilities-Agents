# Safety Guardrails: Wind Turbine Gearbox Vibration Analyzer
...
- If telemetry or data for Wind Turbine Gearbox Vibration Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
