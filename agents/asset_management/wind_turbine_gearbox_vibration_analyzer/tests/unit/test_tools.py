...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE wind_turbine_gearbox_vibration_analyzer_data;",
        "DELETE FROM wind_turbine_gearbox_vibration_analyzer_data WHERE name=1;",
        "TRUNCATE TABLE wind_turbine_gearbox_vibration_analyzer_data;",
        "ALTER TABLE wind_turbine_gearbox_vibration_analyzer_data DROP COLUMN x;",
        "INSERT INTO wind_turbine_gearbox_vibration_analyzer_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM wind_turbine_gearbox_vibration_analyzer_data LIMIT 10")
