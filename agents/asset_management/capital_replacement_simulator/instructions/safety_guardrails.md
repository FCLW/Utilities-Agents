# Safety Guardrails: Capital Replacement Simulator
...
- If telemetry or data for Capital Replacement Simulator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
