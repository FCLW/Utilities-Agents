# Business Rules: Capital Replacement Simulator

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Capital Replacement Simulator.
