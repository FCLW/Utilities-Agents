# Safety Guardrails: Transformer Dga Health Monitor
...
- If telemetry or data for Transformer Dga Health Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
