...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE solar_inverter_string_fault_detector_data;",
        "DELETE FROM solar_inverter_string_fault_detector_data WHERE name=1;",
        "TRUNCATE TABLE solar_inverter_string_fault_detector_data;",
        "ALTER TABLE solar_inverter_string_fault_detector_data DROP COLUMN x;",
        "INSERT INTO solar_inverter_string_fault_detector_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM solar_inverter_string_fault_detector_data LIMIT 10")
