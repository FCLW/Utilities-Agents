# Business Rules: Solar Inverter String Fault Detector

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Solar Inverter String Fault Detector.
