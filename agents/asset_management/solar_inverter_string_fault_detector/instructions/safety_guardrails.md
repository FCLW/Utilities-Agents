# Safety Guardrails: Solar Inverter String Fault Detector
...
- If telemetry or data for Solar Inverter String Fault Detector is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
