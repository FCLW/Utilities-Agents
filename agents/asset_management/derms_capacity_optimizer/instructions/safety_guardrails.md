# Safety Guardrails: Derms Capacity Optimizer
...
- If telemetry or data for Derms Capacity Optimizer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
