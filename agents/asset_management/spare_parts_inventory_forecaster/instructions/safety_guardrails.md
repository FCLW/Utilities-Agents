# Safety Guardrails: Spare Parts Inventory Forecaster
...
- If telemetry or data for Spare Parts Inventory Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
