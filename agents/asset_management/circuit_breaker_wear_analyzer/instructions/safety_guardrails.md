# Safety Guardrails: Circuit Breaker Wear Analyzer
...
- If telemetry or data for Circuit Breaker Wear Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
