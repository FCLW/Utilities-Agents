# Business Rules: Smart Grid Sensor Health Monitor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Smart Grid Sensor Health Monitor.
