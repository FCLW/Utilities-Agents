# Safety Guardrails: Smart Grid Sensor Health Monitor
...
- If telemetry or data for Smart Grid Sensor Health Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
