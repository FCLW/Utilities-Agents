...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE smart_grid_sensor_health_monitor_data;",
        "DELETE FROM smart_grid_sensor_health_monitor_data WHERE name=1;",
        "TRUNCATE TABLE smart_grid_sensor_health_monitor_data;",
        "ALTER TABLE smart_grid_sensor_health_monitor_data DROP COLUMN x;",
        "INSERT INTO smart_grid_sensor_health_monitor_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM smart_grid_sensor_health_monitor_data LIMIT 10")
