# Safety Guardrails: Drone Inspection Image Processor
...
- If telemetry or data for Drone Inspection Image Processor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
