# Business Rules: Drone Inspection Image Processor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Drone Inspection Image Processor.
