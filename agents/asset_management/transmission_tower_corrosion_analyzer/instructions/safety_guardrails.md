# Safety Guardrails: Transmission Tower Corrosion Analyzer
...
- If telemetry or data for Transmission Tower Corrosion Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
