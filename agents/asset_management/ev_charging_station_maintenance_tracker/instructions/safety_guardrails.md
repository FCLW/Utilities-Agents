# Safety Guardrails: Ev Charging Station Maintenance Tracker
...
- If telemetry or data for Ev Charging Station Maintenance Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
