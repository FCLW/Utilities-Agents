#!/usr/bin/env python3
"""
Synthetic data generator for ev_charging_station_maintenance_tracker grounded in golden-dataset.json.
...
def generate_data():
    ...
    domain_name = "asset_management"
    agent_name = "ev_charging_station_maintenance_tracker"
    ...
    schema = {"cols": ['timestamp_column', 'asset_id', 'health_score', 'status_flag', 'anomaly_score', 'entity_name', 'metric_name', 'current_value', 'baseline_target', 'delta_pct', 'substation_or_region', 'details_json']}
