...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE hydro_dam_structural_stress_monitor_data;",
        "DELETE FROM hydro_dam_structural_stress_monitor_data WHERE name=1;",
        "TRUNCATE TABLE hydro_dam_structural_stress_monitor_data;",
        "ALTER TABLE hydro_dam_structural_stress_monitor_data DROP COLUMN x;",
        "INSERT INTO hydro_dam_structural_stress_monitor_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM hydro_dam_structural_stress_monitor_data LIMIT 10")
