# Safety Guardrails: Hydro Dam Structural Stress Monitor
...
- If telemetry or data for Hydro Dam Structural Stress Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
