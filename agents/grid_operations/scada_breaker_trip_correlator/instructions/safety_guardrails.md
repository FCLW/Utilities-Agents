# Safety Guardrails: Scada Breaker Trip Correlator
...
- If telemetry or data for Scada Breaker Trip Correlator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
