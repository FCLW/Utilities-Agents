# Business Rules: Scada Breaker Trip Correlator

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Scada Breaker Trip Correlator.
