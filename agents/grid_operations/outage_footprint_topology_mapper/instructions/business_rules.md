# Business Rules: Outage Footprint Topology Mapper

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Outage Footprint Topology Mapper.
