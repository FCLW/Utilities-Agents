# Safety Guardrails: Outage Footprint Topology Mapper
...
- If telemetry or data for Outage Footprint Topology Mapper is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
