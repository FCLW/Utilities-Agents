# Business Rules: Vegetation Encroachment Lidar Analyzer

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Vegetation Encroachment Lidar Analyzer.
