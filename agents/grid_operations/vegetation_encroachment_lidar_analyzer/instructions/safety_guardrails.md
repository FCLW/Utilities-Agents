# Safety Guardrails: Vegetation Encroachment Lidar Analyzer
...
- If telemetry or data for Vegetation Encroachment Lidar Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
