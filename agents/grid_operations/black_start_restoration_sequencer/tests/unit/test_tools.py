...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE black_start_restoration_sequencer_data;",
        "DELETE FROM black_start_restoration_sequencer_data WHERE name=1;",
        "TRUNCATE TABLE black_start_restoration_sequencer_data;",
        "ALTER TABLE black_start_restoration_sequencer_data DROP COLUMN x;",
        "INSERT INTO black_start_restoration_sequencer_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM black_start_restoration_sequencer_data LIMIT 10")
