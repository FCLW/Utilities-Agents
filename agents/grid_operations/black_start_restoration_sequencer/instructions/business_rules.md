# Business Rules: Black Start Restoration Sequencer

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Black Start Restoration Sequencer.
