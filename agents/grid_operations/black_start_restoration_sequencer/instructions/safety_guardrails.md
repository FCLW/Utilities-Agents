# Safety Guardrails: Black Start Restoration Sequencer
...
- If telemetry or data for Black Start Restoration Sequencer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
