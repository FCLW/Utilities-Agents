# Safety Guardrails: Storm Damage Prediction Modeler
...
- If telemetry or data for Storm Damage Prediction Modeler is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
