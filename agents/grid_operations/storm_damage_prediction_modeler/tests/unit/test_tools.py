...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE storm_damage_prediction_modeler_data;",
        "DELETE FROM storm_damage_prediction_modeler_data WHERE name=1;",
        "TRUNCATE TABLE storm_damage_prediction_modeler_data;",
        "ALTER TABLE storm_damage_prediction_modeler_data DROP COLUMN x;",
        "INSERT INTO storm_damage_prediction_modeler_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM storm_damage_prediction_modeler_data LIMIT 10")
