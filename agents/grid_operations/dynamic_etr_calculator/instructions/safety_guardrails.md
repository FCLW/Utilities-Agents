# Safety Guardrails: Dynamic Etr Calculator
...
- If telemetry or data for Dynamic Etr Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
