# Safety Guardrails: Flisr Switching Simulator
...
- If telemetry or data for Flisr Switching Simulator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
