# Safety Guardrails: Mobile Substation Deployment Planner
...
- If telemetry or data for Mobile Substation Deployment Planner is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
