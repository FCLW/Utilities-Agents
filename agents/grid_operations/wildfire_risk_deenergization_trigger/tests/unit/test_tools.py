...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE wildfire_risk_deenergization_trigger_data;",
        "DELETE FROM wildfire_risk_deenergization_trigger_data WHERE name=1;",
        "TRUNCATE TABLE wildfire_risk_deenergization_trigger_data;",
        "ALTER TABLE wildfire_risk_deenergization_trigger_data DROP COLUMN x;",
        "INSERT INTO wildfire_risk_deenergization_trigger_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM wildfire_risk_deenergization_trigger_data LIMIT 10")
