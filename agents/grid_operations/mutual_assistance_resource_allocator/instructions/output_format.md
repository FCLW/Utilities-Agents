# Output Format: Mutual Assistance Resource Allocator

## Response Structure
All outputs must be strictly formatted and reviewed by the Critic Agent before being returned to the Orchestrator.

1. **Executive Summary**: 2-3 bolded sentences highlighting the critical takeaway regarding Mutual Assistance Resource Allocator.
