# Safety Guardrails: Mutual Assistance Resource Allocator
...
- If telemetry or data for Mutual Assistance Resource Allocator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
