# Business Rules: Emergency Crew Dispatch Router

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Emergency Crew Dispatch Router.
