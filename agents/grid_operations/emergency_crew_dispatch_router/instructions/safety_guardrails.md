# Safety Guardrails: Emergency Crew Dispatch Router
...
- If telemetry or data for Emergency Crew Dispatch Router is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
