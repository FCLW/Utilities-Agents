# Safety Guardrails: Microgrid Generation Forecaster
...
- If telemetry or data for Microgrid Generation Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
