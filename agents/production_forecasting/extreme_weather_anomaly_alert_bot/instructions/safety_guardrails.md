# Safety Guardrails: Extreme Weather Anomaly Alert Bot
...
- If telemetry or data for Extreme Weather Anomaly Alert Bot is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
