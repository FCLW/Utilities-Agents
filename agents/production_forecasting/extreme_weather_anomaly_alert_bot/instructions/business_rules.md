# Business Rules: Extreme Weather Anomaly Alert Bot

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Extreme Weather Anomaly Alert Bot.
