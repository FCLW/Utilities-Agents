# Safety Guardrails: Ev Charging Load Spike Predictor
...
- If telemetry or data for Ev Charging Load Spike Predictor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
