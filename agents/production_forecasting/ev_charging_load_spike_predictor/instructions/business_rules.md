# Business Rules: Ev Charging Load Spike Predictor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Ev Charging Load Spike Predictor.
