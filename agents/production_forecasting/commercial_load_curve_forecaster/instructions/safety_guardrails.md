# Safety Guardrails: Commercial Load Curve Forecaster
...
- If telemetry or data for Commercial Load Curve Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
