# Safety Guardrails: Industrial Load Curve Forecaster
...
- If telemetry or data for Industrial Load Curve Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
