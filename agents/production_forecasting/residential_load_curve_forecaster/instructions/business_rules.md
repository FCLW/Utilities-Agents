# Business Rules: Residential Load Curve Forecaster

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Residential Load Curve Forecaster.
