...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE pumped_hydro_storage_forecaster_data;",
        "DELETE FROM pumped_hydro_storage_forecaster_data WHERE name=1;",
        "TRUNCATE TABLE pumped_hydro_storage_forecaster_data;",
        "ALTER TABLE pumped_hydro_storage_forecaster_data DROP COLUMN x;",
        "INSERT INTO pumped_hydro_storage_forecaster_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM pumped_hydro_storage_forecaster_data LIMIT 10")
