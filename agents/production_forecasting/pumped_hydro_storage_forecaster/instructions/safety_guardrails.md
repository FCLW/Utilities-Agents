# Safety Guardrails: Pumped Hydro Storage Forecaster
...
- If telemetry or data for Pumped Hydro Storage Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
