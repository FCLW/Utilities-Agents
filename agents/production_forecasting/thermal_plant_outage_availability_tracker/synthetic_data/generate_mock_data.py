#!/usr/bin/env python3
"""
Synthetic data generator for thermal_plant_outage_availability_tracker grounded in golden-dataset.json.
...
def generate_data():
    ...
    domain_name = "production_forecasting"
    agent_name = "thermal_plant_outage_availability_tracker"
    ...
    schema = {"cols": ['timestamp_column', 'plant_id', 'generation_mw', 'status_flag', 'anomaly_score', 'entity_name', 'metric_name', 'current_value', 'baseline_target', 'delta_pct', 'substation_or_region', 'details_json']}
