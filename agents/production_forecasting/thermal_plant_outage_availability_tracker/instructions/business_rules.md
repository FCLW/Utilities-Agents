# Business Rules: Thermal Plant Outage Availability Tracker

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Thermal Plant Outage Availability Tracker.
