# Safety Guardrails: Thermal Plant Outage Availability Tracker
...
- **Dataset Restriction**: Only query datasets authorized for the Production Forecasting domain.
...
- If telemetry or data for Thermal Plant Outage Availability Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
