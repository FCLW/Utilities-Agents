# Safety Guardrails: Geothermal Output Forecaster
...
- If telemetry or data for Geothermal Output Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
