# Safety Guardrails: Hydro Inflow Snowpack Estimator
...
- If telemetry or data for Hydro Inflow Snowpack Estimator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
