# Safety Guardrails: Solar Irradiance Predictor
...
- If telemetry or data for Solar Irradiance Predictor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
