# Business Rules: Wind Speed Generation Modeler

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Wind Speed Generation Modeler.
