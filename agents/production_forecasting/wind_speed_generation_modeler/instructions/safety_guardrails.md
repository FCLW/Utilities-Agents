# Safety Guardrails: Wind Speed Generation Modeler
...
- If telemetry or data for Wind Speed Generation Modeler is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
