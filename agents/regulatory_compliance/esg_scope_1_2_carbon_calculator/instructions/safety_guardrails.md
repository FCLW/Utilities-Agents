# Safety Guardrails: Esg Scope 1 2 Carbon Calculator
...
- If telemetry or data for Esg Scope 1 2 Carbon Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
