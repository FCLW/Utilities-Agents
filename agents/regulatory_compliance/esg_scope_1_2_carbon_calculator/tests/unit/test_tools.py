...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE esg_scope_1_2_carbon_calculator_data;",
        "DELETE FROM esg_scope_1_2_carbon_calculator_data WHERE name=1;",
        "TRUNCATE TABLE esg_scope_1_2_carbon_calculator_data;",
        "ALTER TABLE esg_scope_1_2_carbon_calculator_data DROP COLUMN x;",
        "INSERT INTO esg_scope_1_2_carbon_calculator_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM esg_scope_1_2_carbon_calculator_data LIMIT 10")
