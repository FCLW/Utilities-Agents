# Safety Guardrails: Customer Pii Redaction Scrubber
...
- **Dataset Restriction**: Only query datasets authorized for the Regulatory Compliance domain.
...
- If telemetry or data for Customer Pii Redaction Scrubber is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
