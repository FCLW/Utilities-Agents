# Safety Guardrails: Saidi Saifi Reliability Metric Tracker
...
- If telemetry or data for Saidi Saifi Reliability Metric Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
