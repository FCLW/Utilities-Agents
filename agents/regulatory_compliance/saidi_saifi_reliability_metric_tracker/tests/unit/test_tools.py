...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE saidi_saifi_reliability_metric_tracker_data;",
        "DELETE FROM saidi_saifi_reliability_metric_tracker_data WHERE name=1;",
        "TRUNCATE TABLE saidi_saifi_reliability_metric_tracker_data;",
        "ALTER TABLE saidi_saifi_reliability_metric_tracker_data DROP COLUMN x;",
        "INSERT INTO saidi_saifi_reliability_metric_tracker_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM saidi_saifi_reliability_metric_tracker_data LIMIT 10")
