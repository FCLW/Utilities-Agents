...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE puc_rate_case_testimony_drafter_data;",
        "DELETE FROM puc_rate_case_testimony_drafter_data WHERE name=1;",
        "TRUNCATE TABLE puc_rate_case_testimony_drafter_data;",
        "ALTER TABLE puc_rate_case_testimony_drafter_data DROP COLUMN x;",
        "INSERT INTO puc_rate_case_testimony_drafter_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM puc_rate_case_testimony_drafter_data LIMIT 10")
