# Safety Guardrails: Puc Rate Case Testimony Drafter
...
- If telemetry or data for Puc Rate Case Testimony Drafter is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
