# Safety Guardrails: Water Usage Discharge Reporter
...
- If telemetry or data for Water Usage Discharge Reporter is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
