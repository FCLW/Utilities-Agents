# Safety Guardrails: Nerc Cip Cybersecurity Audit Analyzer
...
- If telemetry or data for Nerc Cip Cybersecurity Audit Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
