# Safety Guardrails: Osha Safety Incident Classifier
...
- If telemetry or data for Osha Safety Incident Classifier is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
