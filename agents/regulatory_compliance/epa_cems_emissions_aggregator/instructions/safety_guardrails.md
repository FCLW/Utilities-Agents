# Safety Guardrails: Epa Cems Emissions Aggregator
...
- If telemetry or data for Epa Cems Emissions Aggregator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
