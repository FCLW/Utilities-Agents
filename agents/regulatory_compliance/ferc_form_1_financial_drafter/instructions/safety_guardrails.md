# Safety Guardrails: Ferc Form 1 Financial Drafter
...
- If telemetry or data for Ferc Form 1 Financial Drafter is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
