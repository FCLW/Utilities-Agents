# Business Rules: Ferc Form 1 Financial Drafter

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Ferc Form 1 Financial Drafter.
