...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE ferc_form_1_financial_drafter_data;",
        "DELETE FROM ferc_form_1_financial_drafter_data WHERE name=1;",
        "TRUNCATE TABLE ferc_form_1_financial_drafter_data;",
        "ALTER TABLE ferc_form_1_financial_drafter_data DROP COLUMN x;",
        "INSERT INTO ferc_form_1_financial_drafter_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM ferc_form_1_financial_drafter_data LIMIT 10")
