...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE hazardous_waste_disposal_tracker_data;",
        "DELETE FROM hazardous_waste_disposal_tracker_data WHERE name=1;",
        "TRUNCATE TABLE hazardous_waste_disposal_tracker_data;",
        "ALTER TABLE hazardous_waste_disposal_tracker_data DROP COLUMN x;",
        "INSERT INTO hazardous_waste_disposal_tracker_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM hazardous_waste_disposal_tracker_data LIMIT 10")
