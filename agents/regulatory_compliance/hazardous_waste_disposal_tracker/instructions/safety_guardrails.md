# Safety Guardrails: Hazardous Waste Disposal Tracker
...
- If telemetry or data for Hazardous Waste Disposal Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
