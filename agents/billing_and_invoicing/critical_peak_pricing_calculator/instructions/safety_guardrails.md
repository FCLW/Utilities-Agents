# Safety Guardrails: Critical Peak Pricing Calculator
...
- If telemetry or data for Critical Peak Pricing Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
