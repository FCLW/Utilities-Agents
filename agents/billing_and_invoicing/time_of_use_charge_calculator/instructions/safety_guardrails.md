# Safety Guardrails: Time Of Use Charge Calculator
...
- If telemetry or data for Time Of Use Charge Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
