...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE time_of_use_charge_calculator_data;",
        "DELETE FROM time_of_use_charge_calculator_data WHERE name=1;",
        "TRUNCATE TABLE time_of_use_charge_calculator_data;",
        "ALTER TABLE time_of_use_charge_calculator_data DROP COLUMN x;",
        "INSERT INTO time_of_use_charge_calculator_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM time_of_use_charge_calculator_data LIMIT 10")
