#!/usr/bin/env python3
"""
Synthetic data generator for low_income_assistance_eligibility_checker grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "low_income_assistance_eligibility_checker"
