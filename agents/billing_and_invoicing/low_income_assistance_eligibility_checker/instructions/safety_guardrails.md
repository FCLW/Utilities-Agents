# Safety Guardrails: Low Income Assistance Eligibility Checker
...
- If telemetry or data for Low Income Assistance Eligibility Checker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
