...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE dynamic_real_time_pricing_biller_data;",
        "DELETE FROM dynamic_real_time_pricing_biller_data WHERE name=1;",
        "TRUNCATE TABLE dynamic_real_time_pricing_biller_data;",
        "ALTER TABLE dynamic_real_time_pricing_biller_data DROP COLUMN x;",
        "INSERT INTO dynamic_real_time_pricing_biller_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM dynamic_real_time_pricing_biller_data LIMIT 10")
