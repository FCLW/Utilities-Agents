# Safety Guardrails: Dynamic Real Time Pricing Biller
...
- If telemetry or data for Dynamic Real Time Pricing Biller is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
