# Safety Guardrails: Net Metering Export Credit Processor
...
- If telemetry or data for Net Metering Export Credit Processor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
