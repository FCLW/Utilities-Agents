# Business Rules: Net Metering Export Credit Processor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Net Metering Export Credit Processor.
