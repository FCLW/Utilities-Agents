# Safety Guardrails: Estimated Bill Fallback Generator
...
- If telemetry or data for Estimated Bill Fallback Generator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
