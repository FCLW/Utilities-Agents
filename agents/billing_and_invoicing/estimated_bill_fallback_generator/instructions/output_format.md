# Output Format: Estimated Bill Fallback Generator

## Response Structure
All outputs must be strictly formatted and reviewed by the Critic Agent before being returned to the Orchestrator.

1. **Executive Summary**: 2-3 bolded sentences highlighting the critical takeaway regarding Estimated Bill Fallback Generator.
