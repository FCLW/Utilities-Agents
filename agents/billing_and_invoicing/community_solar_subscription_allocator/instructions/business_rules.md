# Business Rules: Community Solar Subscription Allocator

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Community Solar Subscription Allocator.
