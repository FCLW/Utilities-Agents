# Safety Guardrails: Community Solar Subscription Allocator
...
- If telemetry or data for Community Solar Subscription Allocator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
