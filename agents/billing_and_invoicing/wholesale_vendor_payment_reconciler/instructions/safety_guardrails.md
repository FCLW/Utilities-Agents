# Safety Guardrails: Wholesale Vendor Payment Reconciler
...
- If telemetry or data for Wholesale Vendor Payment Reconciler is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
