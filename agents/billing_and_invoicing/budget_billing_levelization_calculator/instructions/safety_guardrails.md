# Safety Guardrails: Budget Billing Levelization Calculator
...
- If telemetry or data for Budget Billing Levelization Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
