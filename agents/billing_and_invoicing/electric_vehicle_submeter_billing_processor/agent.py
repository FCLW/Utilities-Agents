...
telemetry_callbacks = get_telemetry_callbacks(agent_name="electric_vehicle_submeter_billing_processor")
...
agent = Agent(
    name="electric_vehicle_submeter_billing_processor",
    model="gemini-3.7-flash",
    description="Disaggregates dedicated EV charging submeter interval data from whole-home smart meters to apply specialized off-peak EV charging rate tariffs.",
