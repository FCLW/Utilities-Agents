#!/usr/bin/env python3
"""
Synthetic data generator for electric_vehicle_submeter_billing_processor grounded in golden-dataset.json.
...
def generate_data():
    ...
    domain_name = "billing_and_invoicing"
    agent_name = "electric_vehicle_submeter_billing_processor"
