# Business Rules: Electric Vehicle Submeter Billing Processor

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Electric Vehicle Submeter Billing Processor.
