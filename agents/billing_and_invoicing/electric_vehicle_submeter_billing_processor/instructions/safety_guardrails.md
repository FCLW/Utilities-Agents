# Safety Guardrails: Electric Vehicle Submeter Billing Processor
...
- **Dataset Restriction**: Only query datasets authorized for the Billing And Invoicing domain.
...
- **Tier 2 Definition for this Agent**: Dispatching mass communications to customers or finalizing financial bill generation.
...
- If telemetry or data for Electric Vehicle Submeter Billing Processor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
