# Safety Guardrails: High Bill Spike Anomaly Flag
...
- If telemetry or data for High Bill Spike Anomaly Flag is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
