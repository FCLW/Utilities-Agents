# Safety Guardrails: Day Ahead Lmp Forecaster
...
- If telemetry or data for Day Ahead Lmp Forecaster is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
