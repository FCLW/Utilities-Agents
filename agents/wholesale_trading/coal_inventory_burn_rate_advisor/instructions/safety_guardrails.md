# Safety Guardrails: Coal Inventory Burn Rate Advisor
...
- If telemetry or data for Coal Inventory Burn Rate Advisor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
