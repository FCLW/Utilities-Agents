...
telemetry_callbacks = get_telemetry_callbacks(agent_name="natural_gas_pipeline_constraint_analyzer")
...
agent = Agent(
    name="natural_gas_pipeline_constraint_analyzer",
    model="gemini-3.7-flash",
    description="Monitors interstate pipeline flow notices, compressor outages, and basis spreads to model fuel supply risks for gas-fired generation fleets.",
