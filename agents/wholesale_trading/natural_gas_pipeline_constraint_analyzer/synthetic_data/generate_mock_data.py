#!/usr/bin/env python3
"""
Synthetic data generator for natural_gas_pipeline_constraint_analyzer grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "natural_gas_pipeline_constraint_analyzer"
