# Business Rules: Natural Gas Pipeline Constraint Analyzer

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Natural Gas Pipeline Constraint Analyzer.
...
- Follow industry-standard utility guidelines (e.g., IEEE, NERC, FERC, PUC) applicable to Wholesale Trading.
