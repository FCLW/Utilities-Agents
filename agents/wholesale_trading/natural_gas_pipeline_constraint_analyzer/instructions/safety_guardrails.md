# Safety Guardrails: Natural Gas Pipeline Constraint Analyzer
...
- If telemetry or data for Natural Gas Pipeline Constraint Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
