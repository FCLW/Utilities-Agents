...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE natural_gas_pipeline_constraint_analyzer_data;",
        "DELETE FROM natural_gas_pipeline_constraint_analyzer_data WHERE name=1;",
        "TRUNCATE TABLE natural_gas_pipeline_constraint_analyzer_data;",
        "ALTER TABLE natural_gas_pipeline_constraint_analyzer_data DROP COLUMN x;",
        "INSERT INTO natural_gas_pipeline_constraint_analyzer_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM natural_gas_pipeline_constraint_analyzer_data LIMIT 10")
