# Safety Guardrails: Renewable Energy Certificate Trader
...
- **Dataset Restriction**: Only query datasets authorized for the Wholesale Trading domain.
...
- If telemetry or data for Renewable Energy Certificate Trader is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
