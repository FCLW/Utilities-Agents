# Safety Guardrails: Real Time Lmp Tracker
...
- If telemetry or data for Real Time Lmp Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
