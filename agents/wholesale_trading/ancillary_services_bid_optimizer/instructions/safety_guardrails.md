# Safety Guardrails: Ancillary Services Bid Optimizer
...
- If telemetry or data for Ancillary Services Bid Optimizer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
