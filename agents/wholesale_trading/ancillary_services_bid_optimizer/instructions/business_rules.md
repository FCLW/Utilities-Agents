# Business Rules: Ancillary Services Bid Optimizer

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Ancillary Services Bid Optimizer.
