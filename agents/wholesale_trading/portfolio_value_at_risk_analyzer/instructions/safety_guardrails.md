# Safety Guardrails: Portfolio Value At Risk Analyzer
...
- If telemetry or data for Portfolio Value At Risk Analyzer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
