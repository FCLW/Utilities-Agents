# Safety Guardrails: Carbon Allowance Market Tracker
...
- If telemetry or data for Carbon Allowance Market Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
