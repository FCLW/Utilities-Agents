...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE financial_transmission_right_copilot_data;",
        "DELETE FROM financial_transmission_right_copilot_data WHERE name=1;",
        "TRUNCATE TABLE financial_transmission_right_copilot_data;",
        "ALTER TABLE financial_transmission_right_copilot_data DROP COLUMN x;",
        "INSERT INTO financial_transmission_right_copilot_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM financial_transmission_right_copilot_data LIMIT 10")
