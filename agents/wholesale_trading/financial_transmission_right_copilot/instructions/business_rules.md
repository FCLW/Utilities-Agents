# Business Rules: Financial Transmission Right Copilot

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Financial Transmission Right Copilot.
