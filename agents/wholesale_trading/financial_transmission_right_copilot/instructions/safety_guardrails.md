# Safety Guardrails: Financial Transmission Right Copilot
...
- If telemetry or data for Financial Transmission Right Copilot is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
