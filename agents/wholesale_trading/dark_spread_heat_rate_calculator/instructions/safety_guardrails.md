# Safety Guardrails: Dark Spread Heat Rate Calculator
...
- If telemetry or data for Dark Spread Heat Rate Calculator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
