...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE iso_rto_bidding_curve_generator_data;",
        "DELETE FROM iso_rto_bidding_curve_generator_data WHERE name=1;",
        "TRUNCATE TABLE iso_rto_bidding_curve_generator_data;",
        "ALTER TABLE iso_rto_bidding_curve_generator_data DROP COLUMN x;",
        "INSERT INTO iso_rto_bidding_curve_generator_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM iso_rto_bidding_curve_generator_data LIMIT 10")
