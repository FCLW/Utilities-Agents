# Safety Guardrails: Iso Rto Bidding Curve Generator
...
- If telemetry or data for Iso Rto Bidding Curve Generator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
