# Safety Guardrails: Under Frequency Load Shedding Simulator
...
- If telemetry or data for Under Frequency Load Shedding Simulator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
