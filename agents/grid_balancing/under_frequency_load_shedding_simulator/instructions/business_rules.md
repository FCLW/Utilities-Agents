# Business Rules: Under Frequency Load Shedding Simulator

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Under Frequency Load Shedding Simulator.
