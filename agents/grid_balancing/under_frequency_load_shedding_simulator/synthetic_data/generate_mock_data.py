#!/usr/bin/env python3
"""
Synthetic data generator for under_frequency_load_shedding_simulator grounded in golden-dataset.json.
...
def generate_data():
    ...
    agent_name = "under_frequency_load_shedding_simulator"
