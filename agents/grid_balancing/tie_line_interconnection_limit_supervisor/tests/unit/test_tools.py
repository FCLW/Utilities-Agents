...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE tie_line_interconnection_limit_supervisor_data;",
        "DELETE FROM tie_line_interconnection_limit_supervisor_data WHERE name=1;",
        "TRUNCATE TABLE tie_line_interconnection_limit_supervisor_data;",
        "ALTER TABLE tie_line_interconnection_limit_supervisor_data DROP COLUMN x;",
        "INSERT INTO tie_line_interconnection_limit_supervisor_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM tie_line_interconnection_limit_supervisor_data LIMIT 10")
