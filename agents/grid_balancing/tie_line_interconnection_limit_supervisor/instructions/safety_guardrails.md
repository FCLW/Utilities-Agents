# Safety Guardrails: Tie Line Interconnection Limit Supervisor
...
- If telemetry or data for Tie Line Interconnection Limit Supervisor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
