# Business Rules: Distribution Phase Imbalance Detector

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Distribution Phase Imbalance Detector.
