# Safety Guardrails: Distribution Phase Imbalance Detector
...
- If telemetry or data for Distribution Phase Imbalance Detector is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
