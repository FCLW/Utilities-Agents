# Safety Guardrails: Congestion Node Price Mapper
...
- If telemetry or data for Congestion Node Price Mapper is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
