# Safety Guardrails: Grid Frequency Deviation Monitor
...
- If telemetry or data for Grid Frequency Deviation Monitor is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
