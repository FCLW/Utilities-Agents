...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE grid_frequency_deviation_monitor_data;",
        "DELETE FROM grid_frequency_deviation_monitor_data WHERE name=1;",
        "TRUNCATE TABLE grid_frequency_deviation_monitor_data;",
        "ALTER TABLE grid_frequency_deviation_monitor_data DROP COLUMN x;",
        "INSERT INTO grid_frequency_deviation_monitor_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM grid_frequency_deviation_monitor_data LIMIT 10")
