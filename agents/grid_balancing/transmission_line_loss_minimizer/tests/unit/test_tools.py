...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE transmission_line_loss_minimizer_data;",
        "DELETE FROM transmission_line_loss_minimizer_data WHERE name=1;",
        "TRUNCATE TABLE transmission_line_loss_minimizer_data;",
        "ALTER TABLE transmission_line_loss_minimizer_data DROP COLUMN x;",
        "INSERT INTO transmission_line_loss_minimizer_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM transmission_line_loss_minimizer_data LIMIT 10")
