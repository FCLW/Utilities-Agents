# Safety Guardrails: Transmission Line Loss Minimizer
...
- If telemetry or data for Transmission Line Loss Minimizer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
