# Safety Guardrails: Battery Storage Discharge Optimizer
...
- If telemetry or data for Battery Storage Discharge Optimizer is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
