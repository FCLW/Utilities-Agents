# Business Rules: Islanding Detection And Management Bot

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Islanding Detection And Management Bot.
