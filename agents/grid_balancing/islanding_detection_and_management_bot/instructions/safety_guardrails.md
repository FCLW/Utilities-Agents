# Safety Guardrails: Islanding Detection And Management Bot
...
- If telemetry or data for Islanding Detection And Management Bot is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
