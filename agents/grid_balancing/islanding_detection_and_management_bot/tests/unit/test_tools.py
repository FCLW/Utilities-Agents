...
def test_defensive_sql_guardrails():
    ...
    forbidden_queries = [
        "DROP TABLE islanding_detection_and_management_bot_data;",
        "DELETE FROM islanding_detection_and_management_bot_data WHERE name=1;",
        "TRUNCATE TABLE islanding_detection_and_management_bot_data;",
        "ALTER TABLE islanding_detection_and_management_bot_data DROP COLUMN x;",
        "INSERT INTO islanding_detection_and_management_bot_data VALUES (1);"
    ]
...
def test_bigquery_client_execution(mock_bq_client):
    ...
    result = tool.run("SELECT * FROM islanding_detection_and_management_bot_data LIMIT 10")
