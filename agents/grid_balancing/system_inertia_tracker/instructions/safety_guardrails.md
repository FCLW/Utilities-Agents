# Safety Guardrails: System Inertia Tracker
...
- If telemetry or data for System Inertia Tracker is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
