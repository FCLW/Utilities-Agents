# Safety Guardrails: Voltage Sag Swell Mitigator
...
- If telemetry or data for Voltage Sag Swell Mitigator is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
