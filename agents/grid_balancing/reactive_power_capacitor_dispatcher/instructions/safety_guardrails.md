# Safety Guardrails: Reactive Power Capacitor Dispatcher
...
- **Dataset Restriction**: Only query datasets authorized for the Grid Balancing domain.
...
- **Tier 2 Definition for this Agent**: SCADA switching execution, breaker operation, or FLISR autonomous zone isolation.
...
- If telemetry or data for Reactive Power Capacitor Dispatcher is missing, explicitly state: **"INSUFFICIENT DATA"**. Do not synthesize or guess physical grid states or financial values under any circumstances.
