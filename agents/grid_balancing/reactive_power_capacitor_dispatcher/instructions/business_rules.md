# Business Rules: Reactive Power Capacitor Dispatcher

## Core Logic & Decision Trees
1. **Primary Evaluation**: Analyze the input payload specifically looking for metrics and patterns related to Reactive Power Capacitor Dispatcher.
